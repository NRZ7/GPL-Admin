	...
	class balca_debug_btn
	{
		...
		textureNoShortcut = "";
		/*animTextureNormal = "addons\proving_ground\ui\ui_button_normal_ca.paa";
		animTextureDisabled = "addons\proving_ground\ui\ui_button_disabled_ca.paa";
		animTextureOver = "addons\proving_ground\ui\ui_button_over_ca.paa";
		animTextureFocused = "addons\proving_ground\ui\ui_button_focus_ca.paa";
		animTexturePressed = "addons\proving_ground\ui\ui_button_down_ca.paa";
		animTextureDefault = "addons\proving_ground\ui\ui_button_default_ca.paa";*/
		animTextureNormal = "addons\proving_ground\ui\igui_button_normal_ca.paa";
		animTextureDisabled = "addons\proving_ground\ui\igui_button_disabled_ca.paa";
		animTextureOver = "addons\proving_ground\ui\igui_button_over_ca.paa";
		animTextureFocused = "addons\proving_ground\ui\igui_button_focus_ca.paa";
		animTexturePressed = "addons\proving_ground\ui\igui_button_down_ca.paa";
		animTextureDefault = "addons\proving_ground\ui\igui_button_normal_ca.paa";
		animTextureNoShortcut = "addons\proving_ground\ui\igui_button_normal_ca.paa";
		period = 0.4;
		font = "PuristaBold";
	...
	class balca_debug_list
	{
		...
		colorScrollbar[] = {0.2, 0.2, 0.2, 1};
		arrowEmpty = "addons\proving_ground\ui\ui_arrow_combo_ca.paa";
		arrowFull = "addons\proving_ground\ui\ui_arrow_combo_active_ca.paa";
		wholeHeight = 0.45;
		rowHeight = 0.04;
		color[] = {0.7, 0.7, 0.7, 1};
		colorActive[] = {0,0,0,1};
		...
		class ListScrollBar
		{
			...
			thumb = "addons\proving_ground\ui\ui_scrollbar_thumb_ca.paa";
			arrowFull = "addons\proving_ground\ui\ui_arrow_top_active_ca.paa";
			arrowEmpty = "addons\proving_ground\ui\ui_arrow_top_ca.paa";
			border = "addons\proving_ground\ui\ui_border_scroll_ca.paa";
		};
	};
