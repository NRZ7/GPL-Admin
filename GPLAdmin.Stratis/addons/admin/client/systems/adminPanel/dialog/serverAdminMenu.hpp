...
class ServerAdminMenu
{
	...
	class controls {
		...
		class ServerAdminMenu_options:w_Rsclist
		{
			...
			onButtonDblClick = "[_this] execVM 'addons\admin\client\systems\adminPanel\optionSelect.sqf'";
			x=0.30;
			y=0.18;
			w=0.31;
			h=0.49;
		...
		class ServerAdminMenu_activate:w_RscButton
		{
			idc=-1;
			text="Select";
			onButtonClick = "[1] execVM 'addons\admin\client\systems\adminPanel\optionSelect.sqf'";
			x=0.345;
			y=0.70;
			w=0.22;
			h=0.071;
