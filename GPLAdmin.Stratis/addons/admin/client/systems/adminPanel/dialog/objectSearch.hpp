...
class ObjectSearch
{
	...
	class Controls
	{
		class ObjectSearchFindButton: tw_RscButton
		{
			...
			text = "Find";
			onButtonClick = "[0] execVM 'addons\admin\client\systems\adminPanel\objectSearchInteraction.sqf'";
			x = 0.7375;
			y = 0.2;
			w = 0.1375;
			h = 0.06;
		...
		class ObjectSearchTeleportButton: tw_RscButton
		{
			...
			text = "Teleport";
			onButtonClick = "[1] execVM 'addons\admin\client\systems\adminPanel\objectSearchInteraction.sqf'";
		...
		class ObjectSearchClearMapButton: tw_RscButton
		{
			...
			text = "Clear map";
			onButtonClick = "[2] execVM 'addons\admin\client\systems\adminPanel\objectSearchInteraction.sqf'";
