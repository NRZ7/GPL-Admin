...
class PlayersMenu
{
	...
	class controls {
		...
		/*class UnlockTeamSwitchButton: w_RscButton
		{
			...
			onButtonClick = "[3] execVM 'badmin\client\systems\adminPanel\playerSelect.sqf'";
		...
		class UnlockTeamKillerButton: w_RscButton
		{
			...
			onButtonClick = "[4] execVM 'badmin\client\systems\adminPanel\playerSelect.sqf'";
			x = 0.255 * safezoneW + safezoneX;
			y = 0.748 * safezoneH + safezoneY;
			w = 0.11 * safezoneW;
			h = 0.04 * safezoneH;
		...
		class RemoveAllMoneyButton: w_RscButton
		{
			idc = -1;
			text = "Remove Money";
			onButtonClick = "[5] execVM 'badmin\client\systems\adminPanel\playerSelect.sqf'";
		...
		/*class RemoveAllWeaponsButton: w_RscButton
		{
			idc = -1;
			text = "Remove Weapons";
			onButtonClick = "[6] execVM 'badmin\client\systems\adminPanel\playerSelect.sqf'";
			x = 0.3705 * safezoneW + safezoneX;
			y = 0.748 * safezoneH + safezoneY;
			w = 0.105 * safezoneW;
			h = 0.04 * safezoneH;
		...
		/*class CheckPlayerGearButton: w_RscButton
		{
			idc = -1;
			text = "Gear";
			onButtonClick = "[7] execVM 'badmin\client\systems\adminPanel\playerSelect.sqf'";
		...
		/*class DonationButton: w_RscButton
		{
			idc = -1;
			text = "Donation";
			onButtonClick = "[8] execVM 'badmin\client\systems\adminPanel\playerSelect.sqf'";
