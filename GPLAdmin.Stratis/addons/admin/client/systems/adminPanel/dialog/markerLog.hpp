...
class MarkerLog
{
	...
	onLoad = "execVM 'addons\admin\client\systems\adminPanel\markerLog.sqf'";
	...
	class controls {
		...
		class RefreshButton: w_RscButton
		{
			idc = -1;
			text = "Refresh";
			onButtonClick = "call compile preprocessFileLineNumbers 'addons\admin\client\systems\adminPanel\markerLog.sqf'";
			x = 0.2 * (4/3) * SZ_SCALE_ABS + safezoneX;
